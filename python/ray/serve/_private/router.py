    ...
    async def schedule_and_send_request(
        ...
        while True:
            ...
            try:
                ...
                time4 = time.time()
                logger.info(f'[time AsyncioRouter schedule_and_send_request] successfully sent request {pr.metadata.internal_request_id} to replica {r}! result: {result}, queue_info: {queue_info} in {time4 - time3:.6f} seconds')
